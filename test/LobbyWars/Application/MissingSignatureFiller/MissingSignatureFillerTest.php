...
class MissingSignatureFillerTest extends TestCase
{
    ...
    public function Should_ReturnValidSignature_FromValidData(): void
    {
        ...
        $result = $this->missingSignatureFiller->exec(new MissingSignatureFillerQuery(Notary::TYPE, EmptySignature::TYPE));
    ...
    public function Should_ThrowSignatureWithMoreThanOneEmptyValue(): void
    {
        ...
        $this->missingSignatureFiller->exec(new MissingSignatureFillerQuery(Notary::TYPE, EmptySignature::TYPE.EmptySignature::TYPE));
    }
    ...
    public function Should_ThrowBothSignaturesWithEmptySignature(): void
    {
        ...
        $this->missingSignatureFiller->exec(new MissingSignatureFillerQuery(EmptySignature::TYPE, EmptySignature::TYPE));
    }
    ...
    public function Should_ThrowBothSignaturesWithourEmptySignature(): void
    {
        ...
        $this->missingSignatureFiller->exec(new MissingSignatureFillerQuery(Notary::TYPE, Notary::TYPE));
    }
    ...
    public function Should_ThrowMissingSignatureCannotBeSolved(): void
    {
        ...
        $this->missingSignatureFiller->exec(new MissingSignatureFillerQuery(King::TYPE, EmptySignature::TYPE));
    }
}
